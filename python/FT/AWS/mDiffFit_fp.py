...
def lambda_handler(event, context):   
    ...
    try:
        ...
        return {
            'statusCode': 200,
            'body': json.dumps({"output": filename_fit, "failure_prob":failure_prob})  
        }
        ...
        return {
            'statusCode': 200,
            'body': json.dumps({"fit": "Images don't overlap. No fits file stored to diffs", "failure_prob":failure_prob}) 
        }
